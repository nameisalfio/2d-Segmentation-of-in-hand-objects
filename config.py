...
HOT3D_DATASET_PATH = os.path.join(HOME_DIR, "hot3d") 
...
USE_CAMERAS = ["214-1", "1201-1", "1201-2"]  # Utilizza tutte e tre le telecamere
...
TEST_CLIPS = [f"clip-{i:06d}" for i in range(2800, 2957)]   # Range di clip da utilizzare per test
...
MODEL_SAVE_PATH = os.path.join(MODELS_DIR, "mask_rcnn_final.pth")